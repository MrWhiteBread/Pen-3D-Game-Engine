...
pub fn deferred_f(device: &wgpu::Device, buffers: &Buffers, config: &SurfaceConfiguration, shaders: &Shaders, screen_textures: &ScreenTextures) -> ScreenPassState {
    ...
    let screen_bind_group = device.create_bind_group(&BindGroupDescriptor {
        ...
        entries: &[
            BindGroupEntry {
                binding: 0,
                resource: BindingResource::TextureView(&screen_textures.depth_view),
            },
            BindGroupEntry {
                binding: 1,
                resource: BindingResource::TextureView(&screen_textures.data_view),
            },
            BindGroupEntry {
                binding: 2,
                resource: BindingResource::TextureView(&screen_textures.color_view),
            },
            BindGroupEntry {
                binding: 3,
                resource: BindingResource::TextureView(&screen_textures.uv_view),
            },
            BindGroupEntry {
                binding: 4,
    ...
    let bind_group_layout = device.create_bind_group_layout(&BindGroupLayoutDescriptor {
        label: Some("deferred fragment bind group layout"),
        entries: &[
            BindGroupLayoutEntry {
                binding: 0,
                visibility: ShaderStages::FRAGMENT,
    ...
    let bind_group = device.create_bind_group(&BindGroupDescriptor {
        ...
        label: Some("deferred fragment bind group"),
    });


    let shader = device.create_shader_module(ShaderModuleDescriptor {
        label: Some("deferred fragment Shader"),
        source: ShaderSource::Wgsl(shaders.deferred_fragment.into()),
    });
    ...
    let pipeline = device.create_render_pipeline(&RenderPipelineDescriptor {
        label: Some("deferred fragment pipeline"),
...
impl Pipelines {
    pub fn remake_deferred_f_bind_group(&mut self, device: &wgpu::Device, screen_textures: &ScreenTextures) {
        self.deferred_f.screen_bind_group = device.create_bind_group(&BindGroupDescriptor {
            layout: &self.deferred_f.screen_bind_group_layout,
            entries: &[
                BindGroupEntry {
                    binding: 0,
                    resource: BindingResource::TextureView(&screen_textures.depth_view),
